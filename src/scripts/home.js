...
if (data.events) {
  ...
  function createCategoriesCheckboxes() {
    const categories = Array.from(new Set(data.events.map(item => item.category)));
  
    return categories.map(item => {
      document.getElementById("homeCategoriesContainer").insertAdjacentHTML(
        "beforeend",
        ...
        <div class="card" style="min-height: 25rem">
          ...
          <div class="card-body d-flex flex-column align-items-stretch justify-content-between">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
              ...
              <a href="./src/pages/details.html?id=${item._id}" class="btn btn-outline-danger px-4" data-details="${item._id}">
                Details
              </a>
            </div>
          </div>
  ...
  document.getElementById("homeNavBar").classList.remove("d-none");
