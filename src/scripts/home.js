function createCardsAtHome() {
  for (let event of data.events) {
    document.getElementById('homeContainer').insertAdjacentHTML(
      'beforeend',
        ...
        <div class="card" style="min-height: 25rem" id=${event._id}>
          ...
          <div class="card-body d-flex flex-column align-items-stretch justify-content-between">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
              ...
              <a href="./src/pages/details.html" class="btn btn-outline-danger px-4">Details</a>
            </div>
          </div>
        </div>
      </div>`
